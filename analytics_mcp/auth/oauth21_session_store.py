"""
OAuth 2.1 Session Store for Analytics MCP

Provides a global store for OAuth 2.1 authenticated sessions with
session context management and credential conversion functionality.

Adapted from Google Workspace MCP with identical security guarantees.
"""
