"""
OAuth Callback Response Templates for Analytics MCP

Provides HTML response templates for OAuth authentication flows.
...
<body>
    <div class="container">
        ...
        <div class="message">
            Your Google Analytics credentials have been securely saved. You can now close this window and retry your original command.
        </div>
